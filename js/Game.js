class Game {
    ...
    handleAsteroidCollision(index) 
    {
      if (rockets[index - 1].collide(this.asteroidsGroup)) 
      {
    ...
    play() 
    {
      ...
      if (allPlayers !== undefined) 
      {
        ...
        if (frameCount % 200 === 0) 
        {
          var asteroid = createSprite(0,Math.round(random(0, 50)));
        ...
        if (frameCount % 700 === 0)
        {
          ...
          var enemyShip = createSprite(Math.round(random(50,width - 50), -100));
        ...
        for (var plr in allPlayers) 
        {
          ...
          rockets[index - 1].position.y = y;
            ...
            if (index === player.index) 
            {
              ...
              this.handleAsteroidCollision(index);
            }
